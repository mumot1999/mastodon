    ...
    return (
      <Column icon='asterisk' heading={intl.formatMessage(messages.heading)} hideHeadingOnMobile>
        ...
        <div className='static-content getting-started'>
          <p>
            <a href='https://mastodon.host/about/more' rel='noopener' target='_blank'><FormattedMessage id='getting_started.faq' defaultMessage='FAQ' /></a> • <a href='https://github.com/tootsuite/documentation/blob/master/Using-Mastodon/User-guide.md' rel='noopener' target='_blank'><FormattedMessage id='getting_started.userguide' defaultMessage='User Guide' /></a> • <a href='https://github.com/tootsuite/documentation/blob/master/Using-Mastodon/Apps.md' rel='noopener' target='_blank'><FormattedMessage id='getting_started.appsshort' defaultMessage='Apps' /></a>
          </p>
          <p>
            <FormattedMessage
              id='getting_started.open_source_notice'
              defaultMessage='Mastodon is open source software. You can contribute or report issues on GitHub at <a href="https://github.com/gled-rs/mastodo" rel="noopener" target="_blank">gled-rs/mastodon</a> or on the official repository:<a href="https://github.com/tootsuite/mastodon" rel="noopener" target="_blank">github</a>'
              values={{ github: <a href='https://github.com/gled-rs/mastodo' rel='noopener' target='_blank'>gled-rs/mastodo</a> }}
            />
          </p>
        </div>
      </Column>
